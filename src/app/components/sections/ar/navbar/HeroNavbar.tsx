...
export default function HeroNavbar() {
  return (
    <nav
      id="navbar"
      className="fixed top-0 z-50 w-full text-white transition-all duration-500 ease-in-out"
      dir="rtl"
    >
      <div className="mx-auto px-4 sm:px-6 lg:px-8 py-3 sm:py-4 flex items-center justify-between">
        {/* Mobile: Row for hamburger, logo, and placeholder for alignment */}
        ...
        >
          ...
          <div className="container mx-auto pt-16 space-y-8 sm:space-y-12">
            ...
            <a
              href="/faqs"
              className="block text-lg font-light leading-6 text-white hover:text-gray-200 text-center"
            >
              الأسئلة الشائعة
            </a>
        ...
        {/* Desktop: All navbar in one flex row, aligned center, spaced with justify-between */}
